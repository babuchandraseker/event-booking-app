...
// Run one-time migration: scrollyMedia.json → themeContent.json (must run before any route handlers)
const { migrateScrollyMedia } = require("./src/data/migrateScrollyMedia");
migrateScrollyMedia();
