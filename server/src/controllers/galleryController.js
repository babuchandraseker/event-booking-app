// Gallery loads ONLY from galleryContent.json — Firebase is never used here.
const createRepository = require('../services/localRepository');
console.log('[galleryController] Loading gallery from local JSON (Firebase skipped for gallery).');
