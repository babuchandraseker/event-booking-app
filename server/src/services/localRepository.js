 ...
 *
 * NOTE: Hero content does NOT use this module. Hero is persisted in Firebase
 * Firestore via server/src/services/firestoreHeroRepository.js, exactly like
 * Theme content. This repository only backs gallery:
 *   - gallery →  server/src/data/store/galleryContent.json  (via galleryStore.js)
 *
 * Firebase is never touched for gallery.
 */

const memoryStore = require("../data/memoryStore");

console.log("[localRepository] Firebase skipped for gallery — using local JSON only.");
