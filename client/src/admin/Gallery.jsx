...
import { GALLERY_MAX_ITEMS } from '../lib/hero/constants'
          ...
          <div style={modalStyles.imageSection}>
            ...
            <div style={modalStyles.imageControls}>
              ...
              <button style={modalStyles.uploadBtn} onClick={() => fileRef.current?.click()}>
                Choose JPG/PNG/WebP Image
              </button>
              {fileError && <div style={{ fontSize: 12, color: '#ef4444' }}>{fileError}</div>}
    ...
    <div style={pageStyles.layout}>
      ...
      <main style={pageStyles.main}>
        ...
        <div style={pageStyles.pageHeader}>
          ...
          <button
            style={{ ...pageStyles.addBtn, opacity: items.length >= GALLERY_MAX_ITEMS ? 0.5 : 1 }}
            disabled={items.length >= GALLERY_MAX_ITEMS}
            onClick={() => setModal({ mode: 'add' })}
            title={items.length >= GALLERY_MAX_ITEMS ? `Maximum ${GALLERY_MAX_ITEMS} gallery images reached` : undefined}
          >
            + Add Image ({items.length}/{GALLERY_MAX_ITEMS})
          </button>
        </div>
        ...
        <div style={pageStyles.firebaseBanner}>
          <strong>Gallery Uploads:</strong> Maximum {GALLERY_MAX_ITEMS} images. Accepted formats are JPG, PNG, and WebP, up to 5MB each.
        </div>
      </main>
