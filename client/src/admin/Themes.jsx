...
const SCROLLY_SLOTS = {
  romantic: [
    { slot: 'video',  kind: 'video', label: 'Intro Video',              hint: 'Full-screen cinematic intro video (mp4)',          defaultSrc: null  },
...
const DEFAULT_THEMES = [
  {
    ...
    videoSrc: null, emoji: '', active: true, scrollyMedia: {},
  },
  {
    ...
    features: 'Balloons, Custom banner, Cake', img: '', videoSrc: null,
  ...
  },
  {
    ...
    features: 'Secret setup, Reveal décor, Timing', img: '', videoSrc: null,
    emoji: '🎁', active: true, scrollyMedia: {},
  },
]
