      ...
      <main style={styles.main}>
        <div className="fade-up">
          <div style={styles.header}>
            ...
            <Link to={`${ADMIN_BASE}/bookings`} style={styles.newBtn}>
              View all bookings -&gt;
            </Link>
          </div>
          ...
          <div style={styles.section}>
            <div style={styles.sectionHeader}>
              ...
              <Link to={`${ADMIN_BASE}/bookings`} style={styles.seeAll}>See all</Link>
            </div>
...
const styles = {
  ...
  tableWrap: { background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', overflow: 'hidden' },
