  ...
  return (
    <div className="sst-page" data-theme="birthday">
      ...
      <section className="sst-intro" style={{ backgroundImage: `url('${resolve('scene1', '/themes/birthday/bday1.webp')}')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <video key={resolve('video', '/themes/birthday/bday.mp4')} className="sst-intro-video" autoPlay muted loop playsInline preload="auto" poster={resolve('scene1', '/themes/birthday/bday1.webp')}>
          <source src={resolve('video', '/themes/birthday/bday.mp4')} type="video/mp4" />
        </video>
