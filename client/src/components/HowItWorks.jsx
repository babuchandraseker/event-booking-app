  ...
  return (
    <section ref={ref} className="how-section relative overflow-hidden" id="how-it-works" aria-label="How it works">
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 10% 20%, rgba(201,168,76,0.08), transparent 40%), radial-gradient(circle at 90% 80%, rgba(74,63,143,0.1), transparent 45%)',
        }}
      />
            ...
            {steps.map((s, i) => (
              ...
              >
                <div className="relative z-[1] flex shrink-0 flex-col items-center">
                  <motion.div
                    className="flex h-11 w-11 items-center justify-center rounded-full border border-[rgba(201,168,76,0.35)] bg-[rgba(15,15,26,0.9)] text-sm font-semibold text-gold-light shadow-glow-gold sm:h-14 sm:w-14 sm:text-base"
                ...
                <motion.div
                  className="flex-1 rounded-2xl border border-[rgba(201,168,76,0.12)] bg-[rgba(15,15,26,0.55)] px-5 py-5 text-left shadow-[0_16px_50px_rgba(0,0,0,0.35)] backdrop-blur-md transition-all duration-300 ease-luxury hover:border-[rgba(201,168,76,0.28)] hover:shadow-glow-gold sm:px-7 sm:py-6"
                  whileHover={{ y: -3 }}
                >
