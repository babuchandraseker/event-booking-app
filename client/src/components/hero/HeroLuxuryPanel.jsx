...
export default function HeroLuxuryPanel({ buttonText, onExploreExperiences, onHowToBook }) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="cinematic-hero__actions">
        <button type="button" className="cinematic-hero__btn-primary" onClick={onExploreExperiences}>
          ...
          <span className="cinematic-hero__btn-primary-arrow" aria-hidden>→</span>
        </button>
        <button type="button" className="cinematic-hero__btn-outline" onClick={onHowToBook}>
          How To Book
        </button>
      </div>
      <p className="cinematic-hero__booking-indicator" aria-hidden>
        <span className="cinematic-hero__booking-indicator-check">✓</span> Reserve in 60 Seconds
      </p>
