...
export default function SlotAvailabilitySection() {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_20%_30%,rgba(200,168,75,0.06),transparent_50%),radial-gradient(ellipse_at_80%_70%,rgba(50,35,115,0.16),transparent_45%)]"
        aria-hidden
      />
