...
const NAV = [
  ...
  {
    to: `${BASE}/hero-section`,
    label: 'Hero Section',
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        <rect x="2" y="4" width="6" height="16" rx="1.5" />
        <rect x="9" y="2" width="6" height="20" rx="1.5" />
        <rect x="16" y="4" width="6" height="16" rx="1.5" />
      </svg>
    ),
  },
  {
...
const styles = {
  sidebar: {
    ...
    minHeight: '100vh',
    background: 'linear-gradient(180deg, rgba(14, 6, 24, 0.98), rgba(29, 8, 45, 0.96))',
  ...
  navItemActive: {
    background: 'linear-gradient(90deg, rgba(215,172,40,0.2), rgba(130,56,179,0.13))',
    color: 'var(--accent)',
    fontWeight: 500,
    boxShadow: 'inset 0 0 0 1px rgba(215,172,40,0.24), 0 10px 28px rgba(215,172,40,0.08)',
  },
  navIcon: {
    opacity: 0.8,
    display: 'flex',
