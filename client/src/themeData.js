export const THEME_DATA = {
  romantic: {
    ...
    gallery: [
      { src: '/themes/romantic/romantic1.jpg', label: 'Rose Setup' },
      { src: '/themes/romantic/romantic2.jpg', label: 'Candlelit Table' },
      { src: '/themes/romantic/romantic3.jpg', label: 'Petal Arrangement' },
      { src: '/themes/romantic/romantic4.jpg', label: 'Intimate Corner' },
    ...
    bgFallback: '/themes/romantic/romantic1.jpg'
  },
  birthday: {
